...
class App extends Component {
  ...
  register = async () => {
    ...
    const _details = document.getElementById("details").value;
    ...
    await contract.methods.registerProduct(_name,_details, _price, _quantity).send({ from: accounts[0] });
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <div className="reg">
          <table>
          <tr><td>Enter Product Name : </td><td></td><td><input type="text" id = "name" placeholder="Product Name"></input></td></tr><br></br>
          <tr><td>Enter Product Details : </td><td></td><td><input type="text" id = "details" placeholder="Product Description"></input></td></tr><br></br>
          <tr><td>Enter Product price : </td><td></td><td><input type="text" id = "price" placeholder="Product Price per KG"></input></td></tr><br></br>
          <tr><td>Enter Product quantity : </td><td></td><td><input type="text" id = "quantity" placeholder="Product Quantity in KG"></input></td></tr><br></br>
          <tr><td>Enter Product ID : </td><td></td><td><input type="text" id = "pid" placeholder="Enter Product ID"></input></td></tr><br></br>
          </table>
        <button type="submit" className="btn" onClick={this.register}>Register Product & Display Details</button>
        </div>
        <div>
        ...
        <div>
        <button type="submit" className="btn1" onClick={this.onBuyer}>Buy Product</button>
        </div>
     </div>
     );
  }
