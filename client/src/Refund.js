...
class Refund extends Component {
  ...
  refun = async () => {
    ...
    await contract.methods.refund(_id, _review).send({ from: accounts[0]});
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <button type="submit" className="btn" onClick={this.refun}>Request Refund & Display Details</button>
        </div>
        <div>
        ...
        <div>
            <button type="submit" className="btn1">Buy Product</button>
        </div>
     </div>
    );
  }
